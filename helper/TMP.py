...
# kukaId = p.loadURDF(os.path.join('franka_panda', 'panda.urdf'))
kukaId = p.loadURDF('C:\\Users\\Tom\\OneDrive\\DATA\Riemannien\\implementation\\rmp\\myPybullet_environment\\models\\panda\\panda.urdf', useFixedBase=True)
